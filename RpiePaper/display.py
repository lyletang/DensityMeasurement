...
class Display(object):
	...
	def logo_(cls, screen):
		...
		bmp_name = 'PI.BMP'
		screen.bitmap(75, 0 + 240 + 160, bmp_name)
	...
	def node_name_(cls,screen):
		...
		screen.text(300, 0 + 250, u'Result are as follows :')

		screen.text(360, 0 + 350, u'Weight :')
		screen.text(360, 0 + 350 + 80, u'Volume :')
		screen.text(360, 0 + 350 + 160, u'Density :')
	...
	def info_(cls, screen, weight, volume, density):
		...
		screen.text(590, 0 + 350, u'{weight}'.format(weight = weight))
		screen.text(590, 0 + 350 + 80, u'{volume}'.format(volume = density))
		screen.text(590, 0 + 350 + 160, u'{density}'.format(density = density))
