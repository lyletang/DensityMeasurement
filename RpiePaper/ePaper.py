...
#Project: Waveshar-4.3inch-ePaper(UART)
#Author: Jiahui Tang
#Date: 2017-06-20
...
CMD_SET_EN_FONT     = 0x1F  # set English font
...
class Screen(object):
    ...
    def sleep(self):
        self._send(self._build_frame(CMD_SLEEP))
	...
	#load the pics from tf-card to flash
    def load_pic(self):
        self._send(self._build_frame(CMD_LOAD_PIC))

	#put the pics(.bmp file)
