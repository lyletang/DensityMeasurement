...
> 如上为声波传播时，传播速度与介质密度的关系式，其中，c为超声波在介质中的传播速度，ρ为介质的密度，k为介质的弹性模量常数。
...
> 如上为声波传播速度与环境温度的关系式，其中，C0为零度时的声波传播速度332m/s，T为实际环境温度。 \
...
> 相似材质物体的弹性模量间的差距甚微，例如各类砖，混凝土等合成建材的弹性模量均分布在0.1*10^5MPa左右，各类钢铁制品的弹性模量均分布在2.0*10^5MPa左右，各类锌铝等轻金属，天然岩的弹性模量均分布在1.0*10^5MPa左右，各种烯烃类人工塑料，木材等材质的弹性模量均分布在0.01*10^5MPa左右。 \
